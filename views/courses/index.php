...
$PAGE->set_url(new moodle_url('/theme/remui/views/courses/index.php'));
...
$templatecontext = (object)[
    'formurl' => new moodle_url('/theme/remui/views/courses/index.php'),
    'textcontent' => count($allcourses) . " parcours",
...
if ($pageno == 1) {
    ...
    $previous = true;
    $newpage = $pageno - 1;
    $prevurl = new moodle_url('/theme/remui/views/courses/index.php?pageno=' . $newpage) . $allparams;
}
...
if ($pageno == $total_pages) {
    ...
    $next = true;
    $newpage = $pageno + 1;
    $nexturl = new moodle_url('/theme/remui/views/courses/index.php?pageno=' . $newpage) . $allparams;
}
...
foreach ($courses as $course) {
    ...
    $courseid = $course->id;
    $seeurl = $CFG->wwwroot . "/theme/remui/views/courses/details.php?id=" . $course->id . "&return=adminformations";
    $editurl = $CFG->wwwroot . "/course/view.php?id=" . $course->id;
    $togglevisibleurl = $CFG->wwwroot . "/theme/remui/views/courses/index.php?courseid=" . $course->id . "&togglevisible=1";
    ...
    if ($rolename == "super-admin" || $rolename == "manager" || $rolename == "editingteacher") {
        $content .= '
            <a data-toggle="tooltip" data-placement="top" title="Modifier le parcours" href="' . $editurl . '">
                ...
                $cohortsurl = $CFG->wwwroot . "/theme/remui/views/groups/index.php?courseid=" . $course->id;
                $content .= '
            ...
            if ($rolename == "super-admin" || $rolename == "manager") {
                ...
                $content .= '
                    <a data-toggle="tooltip" data-placement="top" title="Supprimer la formation" onclick="deleteCourse(\'' . new moodle_url('/theme/remui/views/deletecourse.php') . '?id=' . $course->id . '\', \'group\', \''.$possible .'\')">
                        <svg class="iconsvg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                $content .= '
                    <a data-toggle="tooltip" data-placement="top" title="Définir le qcm de fin de module" href="'.new moodle_url('/theme/remui/views/courses/defineqcm.php?courseid='. $course->id).'">
                        <svg class="iconsvg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
