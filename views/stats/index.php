...
$PAGE->set_url(new moodle_url('/theme/remui/views/stats/index.php'));
...
$content .= '<h3 class="FFF-title1" style="margin-top: 80px;">
    <span class="FFABold FFF-White" style="letter-spacing:1px;">Statistiques</span>
</h3>';
...
$content .= '<div class="smartch_flex_mobile" style="width:100%;">';

// $content .= '<div>';
// if ($courseid) {
//     $content .= '<h2 style="letter-spacing:1px;max-width:70%;cursor:pointer;" class="FFARegular FFF-Blue">' . $course->fullname . '</h2>';
// } else if ($categoryid) {
//     $content .= '<h2 style="letter-spacing:1px;max-width:70%;cursor:pointer;" class="FFARegular FFF-Blue">' . $selectedcategory->name . '</h2>';
// } else {
//     $content .= '<h2 style="letter-spacing:1px;max-width:70%;cursor:pointer;" class="FFARegular FFF-Blue"></h2>';
// }
// $content .= '</div>';
