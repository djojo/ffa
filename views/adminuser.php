...
//     $btnconnection = '<a href="' . $urltakerole . '" class="smartch_btn" >Se connecter sous ce nom</a>';
// }
...
//                 <h3 class="FFABold FFF-Blue" style="font-size:16px;">
...
//     'formurl' => new moodle_url('/theme/remui/views/adminuser.php') . '?userid=' . $userid,
//     'textcontent' => "Parcours suivi par " . $user->firstname,
...
//     'formurl' => new moodle_url('/theme/remui/views/adminuser.php')
// ];
...
//                         <div>';
//     if ($group) {
//         $content .= '<a class="smartch_table_btn" href="' . new moodle_url('/theme/remui/views/adminteam.php') . '?teamid=' . $group->id . '&userid=' . $userid . '#selected-' . $userid . '">Consulter</a>';
//     } else {
//         $content .= '<a class="smartch_table_btn" href="' . new moodle_url('/theme/remui/views/formation.php') . '?id=' . $onecourse->id . '">Consulter</a>';
//     }
//     $content .= '</div>
//                     </div>
